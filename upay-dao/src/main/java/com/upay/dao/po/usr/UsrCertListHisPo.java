...
public class UsrCertListHisPo extends BasePo{
	private static final long serialVersionUID = 1L;
	//alias
	public static final String TABLE_ALIAS = "UsrCertListHis";
	...
	public static final String ALIAS_APPLY_REASON = "实名认证申请原因:0:登陆密码重置 1：支付密码重置";
    ...
    /**
     * 实名认证申请原因:0:登陆密码重置 1：支付密码重置       db_column: APPLY_REASON 
     */ 	
