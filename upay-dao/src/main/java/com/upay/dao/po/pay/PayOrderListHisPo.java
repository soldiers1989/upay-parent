...
public class PayOrderListHisPo extends BasePo{
	private static final long serialVersionUID = 1L;
	//alias
	public static final String TABLE_ALIAS = "PayOrderListHis";
	...
	public static final String ALIAS_PAYER_ACCT_NO = "付款方卡号";
	public static final String ALIAS_PAYEE_ACCT_TYPE = "收款方账户类型";
	public static final String ALIAS_PAYEE_ACCT_NO = "收款方卡号";
     ...
     */ 	
	private java.math.BigDecimal orderLmtTime;
    /**
	...
	public java.math.BigDecimal getOrderLmtTime() {
		return this.orderLmtTime;
	}
	
	public void setOrderLmtTime(java.math.BigDecimal value) {
