...
public class MerTest2 extends BaseTest {
    ...
    @Resource(name = "SI_MER0002")
    private IDipperHandler<Message> SI_MER0002;// 二级商户维护
    ...
    public void testMer() throws Exception {
        ...
        Message rspMsg1 = (Message) SI_MER0002.handle(getMessage(body, "SI_MER0002"));
