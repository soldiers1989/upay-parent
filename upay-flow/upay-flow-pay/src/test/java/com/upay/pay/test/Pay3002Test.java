...
public class Pay3002Test extends BaseTest {

    private static final Logger LOG = LoggerFactory.getLogger(Pay3002Test.class);
    ...
    public void test() throws Exception {
        ...
        bodyMap.put("transSubSeq", "20180719000011693084");
