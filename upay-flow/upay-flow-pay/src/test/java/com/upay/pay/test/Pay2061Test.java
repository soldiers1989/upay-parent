...
public class Pay2061Test {
    
    @Resource(name = "SI_PAY2001")
    IDipperHandler<Message> SI_PAY2001;

    @org.junit.Test
   public void test() throws Exception{
       Map<String,Object> headMap=new HashMap<String,Object>();
       headMap.put("transCode", "SI_PAY2001");
//       headMap.put("chnlId", "02");
       ...
       bodyMap.put("transCode", "SI_PAY2001");
       ...
       bodyMap.put("openId", "oUpF8uBHFljwSYt0xhMFNFFg8V7M");
       bodyMap.put("spbillCreateIp", "127.0.0.1");
       bodyMap.put("outerOrderNo", "201807201546484648");
       bodyMap.put("chnlId", "03");
       bodyMap.put("transAmtStr", "1.02");
       ...
       message = SI_PAY2001.handle(message);
