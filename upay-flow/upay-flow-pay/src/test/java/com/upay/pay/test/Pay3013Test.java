...
public class Pay3013Test extends BaseTest {

    private static final Logger LOG = LoggerFactory.getLogger(Pay3013Test.class);
    @Resource(name = "SI_PAY3013")
    IDipperHandler<Message> SI_PAY3013;

    @org.junit.Test
    public void test() throws Exception {
        Map<String, Object> headMap = new HashMap<String, Object>();
        headMap.put("transCode", "SI_PAY3013");
        ...
        bodyMap.put("transCode", "SI_PAY3013");
