...
public class Pay2066Test {
   ...
   public void test() throws Exception{
       ...
       headMap.put("transCode", "SI_PAY2006");
       headMap.put("chnlId", "02");
       headMap.put("platform", "01");
       
       
       //headMap.put("userId", "UR000000000009");
       headMap.put("sessionId", "5e3f470359fb40f49103267e965d9479");
       Map<String,Object> bodyMap=new HashMap<String,Object>();
       //bodyMap.put("payPwd", "123456");
       bodyMap.put("transCode", "SI_PAY2006");
...
//       bodyMap.put("userId", "UR000000000068");
       ...
       bodyMap.put("authCode", "134518314466681095");
//       bodyMap.put("subAppid", "wx7ca539dccf75a2b0");
