...
public class Pay1009Test extends BaseTest {

    private static final Logger LOG = LoggerFactory.getLogger(Pay1009Test.class);
    @Resource(name = "SI_PAY1009")
    IDipperHandler<Message> SI_PAY1009;

    @org.junit.Test
    public void test() throws Exception {
        Map<String, Object> headMap = new HashMap<String, Object>();
        headMap.put("transCode", "SI_PAY1009");
        ...
        bodyMap.put("transCode", "SI_PAY1009");
        bodyMap.put("merNo", "MER2017000119");
        bodyMap.put("secMerNo", "MER2017000119000001");
        bodyMap.put("outerOrderNo", "awefsdfdfer1234123q3");
        bodyMap.put("transAmt", new BigDecimal("1"));
        
        bodyMap.put("curr", "CNY");
        bodyMap.put("spbillCreateIp", "127.0.0.1");
        bodyMap.put("outerOrderStartDate", "20180321000000");
        bodyMap.put("outerOrderEndDate", "20180321235858");
