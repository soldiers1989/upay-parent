...
public class Pay3012Test extends   BaseTest {

    private static final Logger LOG = LoggerFactory.getLogger(Pay3012Test.class);
    @Resource(name = "SI_PAY3012")
    IDipperHandler<Message> SI_PAY3012;

    @org.junit.Test
   public void test() throws Exception{
        Map<String,Object> headMap=new HashMap<String,Object>();
        headMap.put("transCode", "SI_PAY3012");
        ...
        bodyMap.put("transCode", "SI_PAY3012");
        ...
        //金额
        bodyMap.put("transAmtStr", "100");
        /*需要仿真获取 原始交易的信息*/
        String  origOrderId="20171204142217";
        //原消费交易返回的的queryId
        bodyMap.put("origQryId","20171204072954579623");
        //原消费交易返回的的orderId
