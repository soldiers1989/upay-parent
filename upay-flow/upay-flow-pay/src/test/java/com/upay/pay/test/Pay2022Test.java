...
public class Pay2022Test {
	private Logger logger = LoggerFactory.getLogger(Pay2022Test.class);
	
	@Resource(name = "SI_PAY2022")
	private IDipperHandler<Message> SI_PAY2022;

	@org.junit.Test
   public void test() throws Exception{
       Map<String,Object> headMap=new HashMap<String,Object>();
       headMap.put("transCode", "SI_PAY2022");
       headMap.put("chnlId", "03");
       Map<String,Object> bodyMap=new HashMap<String,Object>();
       bodyMap.put("transCode", "SI_PAY2022");
       bodyMap.put("chnlId", "03");
//       bodyMap.put("merNo", "MER2017000211");
       bodyMap.put("outerOrderNo", "20171222163254945553");
       bodyMap.put("subject", "测试商品1");
       bodyMap.put("transAmt", new BigDecimal("1022"));
       ...
       message = SI_PAY2022.handle(message);
