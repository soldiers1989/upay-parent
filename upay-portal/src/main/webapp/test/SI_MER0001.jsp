...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>SI_MER0001特约商户申请测试</title>
	<script type="text/javascript">
		function demo001(){
			doAjax({trans_code:'SI_MER0001',user_id:"UR000000000008"},{MER_NAME:"接口测试",MER_WITHOUT_PWD_SIGN:"1",PAYOPENFLAG:"0",MER_BUSI_TYPE:"01",CONTACT:"testa",CONTACT_TEL:"80000000",CONTACT_MOBILE:"13111111111",CONTACT_EMAIL:"1213131@163.com",MER_TEL:"13111111111",MER_FAX:"123321",MER_ADDR:"测试地址",MER_POSTAL_CODE:"000000",WEBSITE_CODE:"1234560",WEBSITE_NAME:"网站名字",WEBSITE_DOMAIN:"www.321.com",WEBSITE_SCOP:"1qq",COMPANY_NAME:"公司",EGAL_PERSON_NAME:"哈哈",EGAL_PERSON_ID_TYPE:"01",EGAL_PERSON_ID_NO:"58432154111321",COMPANY_ID_TYPE:"22",COMPANY_ID_NO:"51255555",ORG_DEPT_NO:"WE33333",BUSI_LICENSE_ID:"ddddd"})
		}
	</script>
  </head>
