...
public class G4Utils {
    ...
    private static String HanDiviStr[] = new String[] { "", "拾", "佰", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰",
    ...
    public static void copyPropBetweenBeans(Object pFromObj,Object pToObj) {
        if (pToObj != null) {
            try {
                PropertyUtils.copyProperties(pFromObj, pToObj);
            } catch (Exception e) {
    ...
    public static Timestamp getCurrentTimestamp() {
        Object obj = TypeCaseHelper.convert(getCurrentTime("yyyy-MM-dd HH:mm:ss.S"), "Timestamp", "yyyy-MM-dd HH:mm:ss.S");
        if (obj != null)
    ...
    public static Date getCurrentDate(){
        Object obj = TypeCaseHelper.convert(getCurrentTime(), "Date", "yyyy-MM-dd");
        if (obj != null)
            return (Date) obj;
        else
            return null;
    ...
    public static boolean isDb2() {
        boolean out = false;
        String jdbcType = System.getProperty("eRedg4.JdbcType");
        if (jdbcType.equalsIgnoreCase("db2")) {
            out = true;
        }
        return out;
    }
    ...
    public static String getStrDate(String acpdate) {
        String year = acpdate.substring(0, 4);
        String month = acpdate.substring(4, 6);
        String day = acpdate.substring(6, 8);
    ...
    /**
     * 根据一个标示截取，一个字符的开始到这个标示的位置
     *
     * @param str
     * @param sign
     * @return
     */
    public static String getSplitLast(String str, String sign) {
    ...
    /**
     * 根据一个标示截取，标示的后一个位置到末尾
     *
     * @param str
     * @param sign
     * @return
     */
    public static String getSplitStart(String str, String sign) {
    ...
    /*
     * public static void makeOtherProperties(){
     *
     * }
     */
    /**
     ...
     */
    /*
     * public static void removeFile(String outRooot) { try { File file = new
     * File(outRooot); if (file.isFile() && file.exists()) { file.delete();
     * log.info("文件删除成功！"); } if (file.isDirectory() && file.exists()) {
     * FileHelper.deleteDirectory(file); } } catch (Exception e) { log.error(e);
     * // To change body of catch statement use File | // Settings | File
     * Templates. e.printStackTrace(); } }
     */
     ...
     */
    /*
     * public static void makeDir(String outRoot) { String FILE_PATH =
     * outRoot.substring(0, outRoot.indexOf(":\\") + 2); String FILE_NAME =
     * outRoot.substring(outRoot.lastIndexOf("\\") + 1, outRoot.length()); if
     * (isNotEmpty(FILE_NAME)) { File file1 = new File(outRoot); if
     * (file1.exists()) { file1.delete(); } file1.mkdir(); } }
     */
     ...
     */
    /*
     * public static String getDtype(EadtSysDatabaseSource
     * eadtSysDatabaseSource) { String driver =
     * eadtSysDatabaseSource.getDbdriver(); if
     * ("oracle.jdbc.driver.OracleDriver".equals(driver)) { return "oracle"; }
     * else if ("com.microsoft.sqlserver.jdbc.SQLServerDriver" .equals(driver))
     * { return "SQLServer"; } else if
     * ("com.ibm.db2.jcc.DB2Driver".equals(driver)) { return "DB2"; } return
     * null; }
     */
     ...
     * 用于卡Bin数据转换 转换字符
     */
    public static String convertSign(String str) {
        if (G4Utils.isNotEmpty(str)) {
            if (str.equals("全部")) {
                str = "AAAA";
            } else {
     ...
     * @param outRoot
     */
    public static void makeDir(String outRoot) {
        String FILE_PATH = outRoot.substring(0, outRoot.indexOf(":\\") + 2);
        String FILE_NAME = outRoot.substring(outRoot.lastIndexOf("\\") + 1, outRoot.length());
        if (isNotEmpty(FILE_NAME)) {
            File file1 = new File(outRoot);
            if (file1.exists()) {
                file1.delete();
            }
            file1.mkdir();
     ...
     * @return
     */
    public static Dto toMap(Object javaBean) {
     ...
     * @return
     */
    public static Dto toMapForString(Object javaBean) {
        Dto result = new BaseDto();
                ...
                try {
                    ...
                    if (null != value) {
                     	if(method.getReturnType().getName().equals("java.util.Date")){
                    		result.put(field, format((Date) value,"yyyy-MM-dd"));	
                    	}else{
     ...
     * @return
     */
    public static Object convetMap(Class type, Map map) {
        try {
    ...
    public static String getAuditID() {
        return getCurrentTime("yyyyMMddHHmmss") + getUUID().substring(0, 6);
    }
     ...
     * @return zh：中文；en：英文 
     */
    public static String getLocaleLanguage(ServletRequest request) {
   	if (null != request) {
    		return RequestContextUtils.getLocaleResolver((HttpServletRequest)request).resolveLocale((HttpServletRequest)request).getLanguage();
    	}
    	return null;
    }
    ...
    public static String getMobileValidateCode(){   	
    	Random r =new Random();
