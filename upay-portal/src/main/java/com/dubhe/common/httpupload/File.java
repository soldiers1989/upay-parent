...
package com.dubhe.common.httpupload;
...
public class File {
	...
	public void fileToField(ResultSet resultset, String s) throws SQLException,
	...
	public void saveAs(String s) throws SmartUploadException, IOException {
		saveAs(s, 0);
	}

	public void saveAs(String s, int i) throws SmartUploadException,
			IOException {
		...
		try {
			...
			IOHelper.saveFile(file, m_parent.m_binArray, m_startData, m_size);
		} catch (Exception _ex) {
			throw new IllegalArgumentException(
