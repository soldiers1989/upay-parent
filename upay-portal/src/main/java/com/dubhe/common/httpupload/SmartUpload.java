...
{
    private static Logger log = LoggerFactory.getLogger(SmartUpload.class);
        ...
        throws SmartUploadException, IOException, ServletException
    {
        ...
        do
        {
            ...
            if(isFile)
            {
            	com.dubhe.common.httpupload.File newFile = new com.dubhe.common.httpupload.File();
    ...
    private String getDataHeader()
    {
        ...
        try {
            ...
            log.error(FunIMsgFormat.MsgStyle.DEFAULT_LOG.getFormat("结束执行{}的getDataHeader方法,执行的结果是{}。"),
    ...
    /**
     * 对下载显示的文件名进行UTF-8编码. 解决下载中文文件名乱码问题.
     * 
     * @param fileName
     * @return
     */
