...
*/	
    ...
    IDipperHandler<Message> SI_MER0010;	//商户费率规则信息查询
    ...
    public void testDemo() throws Exception {
     /*   Map<String, Object> bodyMap = new HashMap<String, Object>();
        ...
        bodyMap1.put("transCode", "SI_MER0010");
        bodyMap1.put("feeCode", "0006  ");
        //bodyMap1.put("feeName", "商户");
        ...
        Message message1 =
                MessageFactory.create(IdGenerateFactory.generateId(), MessageFactory.createSimpleMessage(
                    ...
                    Constants.ResponseCode.SUCCESS, "success"), new LinkedList<Store>());
        message1 = SI_MER0010.handle(message1);
