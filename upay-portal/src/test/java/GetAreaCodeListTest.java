...
public class GetAreaCodeListTest {
    @Resource(name = "SI_GNR0001")
    IDipperHandler<Message> SI_GNR0001;
    ...
    public void testDemo() throws Exception {
        ...
        headMap.put("transCode", "SI_GNR0001");
        ...
        message = SI_GNR0001.handle(message);
