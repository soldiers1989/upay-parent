...
*/	
    ...
    IDipperHandler<Message> SI_MER0011;	//商户费率规则信息查询


    @org.junit.Test
    public void testDemo() throws Exception {
    	SimpleDateFormat sim = new SimpleDateFormat("yyyy-MM-dd");
    	String start = "2016-8-17";
    	String end = "2016-7-28";
        ...
        Message message1 =
                MessageFactory.create(IdGenerateFactory.generateId(), MessageFactory.createSimpleMessage(
                    ...
                    Constants.ResponseCode.SUCCESS, "success"), new LinkedList<Store>());
        message1 = SI_MER0011.handle(message1);
