 ...
 *
 */
package com.upay.gateway.server.acpreceive.run;
...
public class Startup {
    public static void main(String[] args) {
        StartupUtil su = StartupUtil.getInstance("upay-gateway-server-acpreceive", args);
        ...
        Bootstrap.main(new String[]{"upay-gateway-server-acpreceive"});
    }
}
