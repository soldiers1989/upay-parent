 ...
 *
 */
package com.upay.gateway.server.acpmer.run;
...
public class Startup {
    public static void main(String[] args) {
        StartupUtil su = StartupUtil.getInstance("upay-gateway-server-acpmer", args);
        ...
        Bootstrap.main(new String[]{"upay-gateway-server-acpmer"});
    }
}
