package com.upay.gateway.server.weixin;
...
public class XmlSvrController {
    ...
    private static final String channelid = "weixinsvr";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            context.insert(context.indexOf("</xml>"), "<tran_code>WEIXIN0001</tran_code>");
            ...
            IDipperHandler<Message> httpsvrFlowHandler =
                    Bootstrap.getApplicationContext().getBean("SI_httpsvrFlow", IDipperHandler.class);
