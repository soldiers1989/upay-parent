 ...
 * 
 */
public class AT_AlipaySubMchQueryMerHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipaySubMchQueryMerHandler.class);
