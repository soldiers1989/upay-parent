 ...
 * 
 */
public class AT_AlipayCancelHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipayCancelHandler.class);
