 ...
 * 
 */
public class AT_AlipayCloseHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipayCloseHandler.class);
