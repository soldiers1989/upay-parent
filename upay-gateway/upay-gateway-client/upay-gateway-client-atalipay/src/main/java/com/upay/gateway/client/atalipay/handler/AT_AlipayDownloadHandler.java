 ...
 * 
 */
public class AT_AlipayDownloadHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipayDownloadHandler.class);
