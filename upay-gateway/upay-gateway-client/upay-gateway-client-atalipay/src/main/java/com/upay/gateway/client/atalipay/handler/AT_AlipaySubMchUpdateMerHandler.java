 ...
 * 
 */
public class AT_AlipaySubMchUpdateMerHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipaySubMchUpdateMerHandler.class);
