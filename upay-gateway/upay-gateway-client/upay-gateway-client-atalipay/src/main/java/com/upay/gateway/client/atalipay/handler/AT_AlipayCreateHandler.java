 ...
 * 
 */
public class AT_AlipayCreateHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipayCreateHandler.class);
