 ...
 * 
 */
public class AT_AlipayQueryHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AT_AlipayQueryHandler.class);
