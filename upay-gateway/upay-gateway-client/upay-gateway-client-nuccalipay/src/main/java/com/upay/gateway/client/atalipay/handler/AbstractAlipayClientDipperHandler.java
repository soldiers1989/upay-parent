...
import com.upay.gateway.client.atalipay.util.HttpClientConnManager;
...
public abstract  class AbstractAlipayClientDipperHandler extends AbstractClientDipperHandler {
    ...
    private String signatureCode="4002507279";
    @Override
...
//            }
            //加签
            UnionMessage um = api.servEA11(signatureCode, AlipayUtil.mapToXml(reqParam), 0);
            reqParam.put("sign", um.getBodyField("sign"));
            //发送请求到网联
            HttpClientConnManager httpclient=new HttpClientConnManager();
            String responsStr=httpclient.send(url, AlipayUtil.mapToXml(reqParam), reqParam);
