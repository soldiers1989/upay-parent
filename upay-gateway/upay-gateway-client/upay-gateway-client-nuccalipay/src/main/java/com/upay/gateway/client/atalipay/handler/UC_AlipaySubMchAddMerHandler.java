 ...
 * 
 */
public class UC_AlipaySubMchAddMerHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(UC_AlipaySubMchAddMerHandler.class);
