 ...
 * 
 */
public class UC_AlipaySubMchUpdateMerHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(UC_AlipaySubMchUpdateMerHandler.class);
