 ...
 * 
 */
public class UC_AlipayRefundQueryHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(UC_AlipayRefundQueryHandler.class);
