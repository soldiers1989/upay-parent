 ...
 * 
 */
public class UC_AlipayPreCreateHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(UC_AlipayPreCreateHandler.class);
