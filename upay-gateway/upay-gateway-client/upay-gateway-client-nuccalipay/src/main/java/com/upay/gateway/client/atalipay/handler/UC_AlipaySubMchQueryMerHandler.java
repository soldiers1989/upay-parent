 ...
 * 
 */
public class UC_AlipaySubMchQueryMerHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(UC_AlipaySubMchQueryMerHandler.class);
