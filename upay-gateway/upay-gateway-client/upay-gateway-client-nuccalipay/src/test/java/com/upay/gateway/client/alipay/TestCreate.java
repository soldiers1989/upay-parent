...
public class TestCreate {
	...
	public static void main(String[] args) throws Exception {
		...
		IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx
				.getBean("AT_AlipayCreateHandler");
		...
		map.put("outTradeNo", "201808080101011361138579"); // 商户订单号
		map.put("merchantId", "2088231277168753"); //间连受理商户的支付宝商户编号
//		map.put("sellerId", ""); // 卖家支付宝用户ID 如果该值为空，则默认为商户签约账号对应的支付宝用户ID
		map.put("totalAmount", "0.01"); // 订单总金额，单位为元
//		map.put("disAmount", ""); // 参与优惠计算的金额
		map.put("subject", "测试商品"); // 订单标题
//		map.put("body", "特价手机"); // 订单描述
		map.put("buyerId", "2088112002599832"); // 用户userid
		// 订单包含的商品列表信息.
