...
import static com.pactera.dipper.exception.SysErrCode.*;
...
public abstract class AbstractAcpClientDipperHandler extends AbstractClientDipperHandler {
    ...
    @Autowired
    private DefaultAcpClientDipperHandler defaultAcpClientDipperHandler;
...
//            /** 请求地址 */
//            if(targetBodyMap.get("bizType").equals("000803")){
...
//            constantMap.put(CmparmConstants.ACP_SIGN_METHOD, "01");
            ...
            defaultAcpClientDipperHandler.handle(message);
    ...
    public String getAcpConnectionTimeout() {
        return acpConnectionTimeout;
    }
    ...
    public String getAcpReadTimeout() {
        return acpReadTimeout;
    }
