...
public class Test2522 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx.getBean("SA_ZJPAY_Pay2522Handler");
        ...
        // head
        map.put("_TRAN_CODE", "2522");
        map.put("InstitutionID", "002367");
        // body
        map.put("txSN", "201707201618256336588893583");
