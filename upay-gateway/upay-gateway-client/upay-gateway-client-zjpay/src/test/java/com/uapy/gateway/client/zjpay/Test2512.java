...
public class Test2512 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx.getBean("SA_ZJPAY_Pay2512Handler");
        ...
        // head
        map.put("_TRAN_CODE", "2512");
        map.put("institutionID", "002366"); // 机构编号
        // body
        map.put("paymentNo", "201609201617590011134567892"); // 支付交易流水号
