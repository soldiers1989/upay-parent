...
public class Test1132 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx.getBean("SA_ZJPAY_Pay1132Handler");
        ...
        // head
        map.put("_TRAN_CODE", "1132");
        map.put("institutionID", "002366"); // 机构编号
        // body 15120915572400654947
        map.put("serialNumber", "201708221031022816129239804"); // 交易流水号
