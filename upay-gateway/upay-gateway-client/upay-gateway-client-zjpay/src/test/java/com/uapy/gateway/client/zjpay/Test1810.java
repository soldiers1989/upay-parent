...
public class Test1810 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx.getBean("SA_ZJPAY_Pay1810Handler");
        ...
        // head
//        map.put("_TRAN_CODE", "1810");
        map.put("institutionID", "002367");
        // body
        //map.put("TxSN", "15120915572400654946");

        map.put("searchDate", "20180530");
