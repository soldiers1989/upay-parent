...
public class Test2511 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx.getBean("SA_ZJPAY_Pay2511Handler");
        ...
        // head
        map.put("_TRAN_CODE", "2511");
        map.put("institutionID", "002366"); // 机构编号
        // body 15120915572400654947
        map.put("paymentNo", "201609201617591113111562892"); // 支付交易流水号
        map.put("amount", new BigDecimal("1")); // 结算金额 单位 分
        map.put("txSNBinding", "20161028141730000089"); // 绑定流水号
                                                               // 即2501中的绑定流水号
        map.put("settlementFlag", "0001"); // 备注
        map.put("remark", "30");
