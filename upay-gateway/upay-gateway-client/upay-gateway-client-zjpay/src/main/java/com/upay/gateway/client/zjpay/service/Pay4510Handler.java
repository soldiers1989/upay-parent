...
public class Pay4510Handler extends DefaultZJPayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(Pay4510Handler.class);


    @Override
    protected void setInitParam(Map<String, Object> arg0) {
        log.info("中金机构支付账户余额查询start");
        // head
        arg0.put(Channel._TRAN_CODE_NAME, "4510");
