 ...
 * 
 */
public class Pay4538Handler extends DefaultZJPayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(Pay4538Handler.class);


    @Override
    protected void setInitParam(Map<String, Object> arg0) {
        log.info("中金支付单笔代付查询初始化start");
        // head
        arg0.put(Channel._TRAN_CODE_NAME, CmparmConstants.GATEWAY_ZJPAY_4538);
    ...
    protected void doErrorHandle(Map<String, Object> target, Fault fault) {
        log.info("中金支付单笔代付查询doErrorHandle start!");
        ...
        log.info("中金4532接口，返回值[{}]", backCode);
    ...
    protected void doFailureHandle(Map<String, Object> source, Map<String, Object> target, Fault fault) {
        log.info("中金支付单笔代付查询doFailureHandle start!");
        String backCode = fault.getCode();
        log.info("中金4532接口，返回值[{}]", backCode);
        CommonUtil.returnMsg(fault, backCode);
    ...
    protected void doSuccessHandle(Map<String, Object> source, Map<String, Object> target, Fault arg2) {
        log.info("中金支付单笔代付查询doSuccessHandle start!");
