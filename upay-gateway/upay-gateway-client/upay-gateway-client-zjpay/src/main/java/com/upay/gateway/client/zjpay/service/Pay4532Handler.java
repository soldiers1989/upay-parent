 ...
 * 
 */
public class Pay4532Handler extends DefaultZJPayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(Pay4532Handler.class);
    ...
    protected void setInitParam(Map<String, Object> arg0) {
        ...
        // head
        arg0.put(Channel._TRAN_CODE_NAME, CmparmConstants.GATEWAY_ZJPAY_4532);
