...
public class Pay2522Handler extends DefaultZJPayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(Pay2522Handler.class);


    @Override
    protected void setInitParam(Map<String, Object> arg0) {
        log.info("快捷支付退款查询start");
        arg0.put(Channel._TRAN_CODE_NAME, "2522");// 交易码
        arg0.put("institutionID", CmparmConstants.GATEWAY_ZJPAY_INSTITUTION_ID); // 机构编号
        // head
//        arg0.put(Channel._TRAN_CODE_NAME, "2522"); // 交易码
//        arg0.put("InstitutionID", "001853"); // 机构编号
        // body
        arg0.put("txSN", arg0.get("txSN"));// 退款交易流水号
        log.info("快捷支付退款查询end");
    }
