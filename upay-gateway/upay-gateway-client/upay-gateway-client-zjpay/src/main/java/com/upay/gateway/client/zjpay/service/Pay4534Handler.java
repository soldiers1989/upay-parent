 ...
 * 
 */
public class Pay4534Handler extends DefaultZJPayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(Pay4534Handler.class);
    ...
    protected void setInitParam(Map<String, Object> arg0) {
        ...
        // head
        arg0.put(Channel._TRAN_CODE_NAME, CmparmConstants.GATEWAY_ZJPAY_4534);
        ...
        arg0.put("txSN", arg0.get("sysSeq")); // 代付流水号
