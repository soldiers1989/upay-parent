...
public class WXPayUtil {
	 ...
	 * XML格式字符串转换为Map
	 */
	public static Map<String, String> newXmlToMap(String strXML) throws Exception {
		try {
	 ...
	 * @return 含有sign字段的XML
	 */
	public static String generateSignedXml(final Map<String, Object> data, String key)
			throws Exception {
	...
	public static String getSignContent(Map<String, Object> sortedParams, String... values) {
