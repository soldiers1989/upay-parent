...
import com.upay.gateway.client.atweixin.util.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;;
...
public class WXPayRequest {
	 ...
	 * @throws Exception
	 */
	public int send(Map<String, Object> data, String encoding) throws Exception {
		try {
			...
			WXPayUtil.getLogger().info("请求报文(对每个报文域的值均已做url编码):[" + sendData + "]");
