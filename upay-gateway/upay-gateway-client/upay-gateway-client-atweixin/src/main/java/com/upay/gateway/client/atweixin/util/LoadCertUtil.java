...
public class LoadCertUtil {
	...
	public static void main(String[] args) {
		...
		String pfxkeyfile ="D:\\工作文档\\AT\\T公钥\\00010000new2048(3).pfx";
		String password = "000000";
		String pubkeyfile1 ="D:\\certs\\acp_test_verify_sign.cer";
		String pubkeyfile2 ="D:\\工作文档\\AT\\T公钥\\1900009131_20180326_cert.pem";
		String pubkeyfile3 ="D:\\工作文档\\AT\\T公钥\\1900009131_wxp_cert.pem";
		...
		PublicKey publicKey1 = loadPubkey(pubkeyfile1);
		System.out.println("1公钥内容："+Base64.encodeBase64String(publicKey1.getEncoded()));
		PublicKey publicKey2 = loadPubkey(pubkeyfile2);
		System.out.println("2公钥内容："+Base64.encodeBase64String(publicKey2.getEncoded()));
		PublicKey publicKey3 = loadPubkey(pubkeyfile3);
		System.out.println("3公钥内容："+Base64.encodeBase64String(publicKey3.getEncoded()));
	}
}