 ...
 * @author hry
 */
public class UnionPayOrderRefundQueryClientDipperHandlr extends AbstractAtWeiXinClientDipperHandler{
	...
	protected void setInitParam(Map<String, Object> paramMap) {
		...
		paramMap.put("out_refund_no", paramMap.get("transSubSeq"));
