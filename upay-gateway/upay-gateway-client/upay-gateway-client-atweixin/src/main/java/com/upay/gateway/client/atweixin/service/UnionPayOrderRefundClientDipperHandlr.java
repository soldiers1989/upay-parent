 ...
 * @author hry
 */
public class UnionPayOrderRefundClientDipperHandlr extends AbstractAtWeiXinClientDipperHandler{
	@Override
	protected void setInitParam(Map<String, Object> paramMap) {
		paramMap.put("transCode", paramMap.get("tranCode"));
		paramMap.put("out_trade_no", paramMap.get("outTradeNo"));
		paramMap.put("out_refund_no",paramMap.get("outerRefundNo"));
		paramMap.put("refund_fee",paramMap.get("oriTotalFee"));
		paramMap.put("total_fee",paramMap.get("totalFeeRefund"));	
		paramMap.put("refund_fee_type", "CNY");
		paramMap.remove("tranCode");
		paramMap.remove("outerRefundNo");
		paramMap.remove("oriTransSubSeq");
		paramMap.remove("outTradeNo");
		paramMap.remove("oriTotalFee");
		paramMap.remove("totalFeeRefund");
	}
