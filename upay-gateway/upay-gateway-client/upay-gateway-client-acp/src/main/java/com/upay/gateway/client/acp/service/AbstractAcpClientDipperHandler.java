...
public abstract class AbstractAcpClientDipperHandler extends AbstractClientDipperHandler {
    public static final Logger LOG = LoggerFactory.getLogger(AbstractAcpClientDipperHandler.class);
    private static final String FLAG_FAILURE = "failure";
    private static String ACP_VERSION = "version";
    private static String ENCRYPT_CERTID="encryptCertId";
    ...
    public Message handle(Message m) throws Exception {
        ...
        try {
            ...
            constantMap.put(ENCRYPT_CERTID, AcpService.getEncryptCertId());
            constantMap.put(CmparmConstants.ACP_ISSCODE, issCode);
            constantMap.put(CmparmConstants.ACP_ACQCODE, issCode);
            constantMap.put(ACP_VERSION, qrcAcpVersion);
    ...
    public void setQrcAcpVersion(String qrcAcpVersion) {
		this.qrcAcpVersion = qrcAcpVersion;
	}
