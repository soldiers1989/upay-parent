package com.upay.gateway.client.weixin.util;
...
public class WeixinUtil {
	 ...
	 *            accessToken
	 */
	public static Map<String, Object> checkAccessToken(String accessToken,
			String openid) {
		Map<String, Object> returnMap = new HashMap<String, Object>();
	 ...
	 *            公众号的appsecret
	 */
	public static Map<String, Object> getOpenId(String code, String appId,
			String appSecret) {
		Map<String, Object> returnMap = new HashMap<String, Object>();
	 ...
	 *            回调地址
	 */
	public static String getCodeUrl(String appId, String redirectUri,
			String state) {
	...
	public static void main(String args[]) throws ParseException {
		 ...
		 */
		String appId = "wx3950cc559a1244f4";
		String code = "001zxZ8h0GrTJC1CUS9h0mUW8h0zxZ8o";
		String appSecret = "c3c0b9011961fa81b669f7e9fa4114a5";
