 ...
 * 
 */
public class DefaultWeiXinClientHandler extends AbstractClientDipperHandler {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultWeiXinClientHandler.class);
