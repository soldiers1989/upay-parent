...
//      IDipperHandler<Message> handler = def.getHandlerBeanDefinition().getCommServiceRef();
      IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx.getBean("defaultWeiXinSecapiClientHandler");
...
//       (IDipperHandler<Message>) ctx.getBean("orderQueryPayClientHandler");
        ...
        map.put("nonceStr", "");
        map.put("sign", "");        
        map.put("outTradeNo", "1160150619");
        map.put("transactionId", "4001242001201608232017301581");
