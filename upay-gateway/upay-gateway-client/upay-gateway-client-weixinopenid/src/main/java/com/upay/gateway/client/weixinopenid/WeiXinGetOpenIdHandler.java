 ...
 * 
 */
package com.upay.gateway.client.weixinopenid;
...
import com.upay.gateway.client.weixinopenid.util.WeixinUtil;
...
public class WeiXinGetOpenIdHandler implements IDipperHandler<Message> {
    ...
    public String getJumpLinkWeixin() {
        return jumpLinkWeixin;
    }

    public void setJumpLinkWeixin(String jumpLinkWeixin) {
        this.jumpLinkWeixin = jumpLinkWeixin;
    }
