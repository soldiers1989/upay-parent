...
public class TestSubMchUpdateMer {
	...
	public static void main(String[] args) throws Exception {
		...
		IDipperHandler<Message> handler = (IDipperHandler<Message>) ctx
				.getBean("AlipaySubMchUpdateMerHandler");
		...
		map.put("externalId", "MER2017000119");
		map.put("servicePhone", "13222222222");
		map.put("merName", "天天超市");//商户名称
		map.put("aliasName", "天天"); //商户简称 
		map.put("categoryId", "2015091000052157"); //商户经营类目
		map.put("alipaySource", "2088821147231702");//商户来源机构标识，填写机构在支付宝的pid
		map.put("subMerchantId", "2088921560866102");
