 ...
 * 
 */
public class AlipaySubMchAddMerHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AlipaySubMchAddMerHandler.class);
