 ...
 * 
 */
public class AlipayPreCreateHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AlipayPreCreateHandler.class);
