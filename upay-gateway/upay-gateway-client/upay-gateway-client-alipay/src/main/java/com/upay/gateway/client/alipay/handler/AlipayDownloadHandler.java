 ...
 * 
 */
public class AlipayDownloadHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AlipayDownloadHandler.class);
