 ...
 * 
 */
public class AlipayRefundQueryHandler extends DefaultAlipayClientHandler {

    private static final Logger log = LoggerFactory.getLogger(AlipayRefundQueryHandler.class);
