 ...
 * 
 */
public class UnionPayReceiveConsumeClientDipperHandler extends
	...
	protected void setInitParam(Map<String, Object> init) {
		init.put("tranCode", "11");                             
		init.put("txnSubType", "02");                           //交易子类型
		...
		init.put("txnTime", AcpToolUtil.getCurrentTime());
