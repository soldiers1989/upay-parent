...
public class SumTodayRouteFeeTest {
    ...
    public void testExecute() throws Exception {
    	...
    	batchParams.setBatchNo("20125784521023");
    	batchParams.setPreDate(DateUtil.parse("2017-08-14", "yyyy-MM-dd"));
    	batchParams.setTranDate(DateUtil.parse("2017-08-15", "yyyy-MM-dd"));
