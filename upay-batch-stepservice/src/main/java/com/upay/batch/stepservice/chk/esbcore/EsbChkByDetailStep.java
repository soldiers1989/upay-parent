...
public class EsbChkByDetailStep extends AbstractStepExecutor<Object, PayFlowListPo> {
    private final static Logger logger = LoggerFactory.getLogger(EsbChkByDetailStep.class);
