...
public class ChkByWeChatStep extends AbstractStepExecutor<Object, ChkThirdDetailPo> {
    private final static Logger logger = LoggerFactory.getLogger(ChkByWeChatStep.class);
