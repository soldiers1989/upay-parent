...
import com.upay.batch.stepservice.chk.alipay.ChkByAlipayDetailStep;
...
public class ChkByAlipayDetailStepAT extends AbstractStepExecutor<Object, PayFlowListPo> {
    ...
    public List<PayFlowListPo> getDataList(BatchParams batchParams, int offset, int pageSize,
        ...
        transDate= DateUtil.getYMD(transDate).getTime();
