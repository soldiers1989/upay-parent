...
public class ApplyCoreChkFileStep extends AbstractStepExecutor<Object, Object> {

    private final static Logger logger = LoggerFactory.getLogger(ApplyCoreChkFileStep.class);
    ...
    public void execute(BatchParams batchParams, int index, Object data, Object object)
        ...
        body.put("bankDate",dateFormat.format(batchParams.getPreDate()));
