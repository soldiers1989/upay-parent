...
public abstract class WebUtils {
    ...
    private static final String mobile_user_agent="Mozilla/5.0 (Windows NT 6.1; WOW64; rv:7.0a1) Gecko/20110623 Firefox/7.0a1 Fennec/7.0a1";
    private static final String web_user_agent="Mozilla/5.0 (Windows NT 10.0; WOW64; rv:51.0) Gecko/20100101 Firefox/51.0";
    ...
    public static String doPost(String url, Map<String, String> params, String charset,
        ...
        if("01".equals(params.get("chnlId")==null?"":params.get("chnlId"))){;
            isMobile=true;
        }
        String query = buildXml(params, charset);
        byte[] content = {};
        if (query != null) {
            content = query.getBytes(charset);
        }
        return doPost(url, ctype, content, connectTimeout, readTimeout,isMobile);
    }
    ...
    public static String doPost(String url, String ctype, byte[] content, int connectTimeout,
                                int readTimeout,boolean isMobile) throws IOException {
        ...
        try {
            try {
                ...
                LoggerUtil.logCommError(e, url, map.get("transCode"), content);
                throw e;
            }
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                LoggerUtil.logCommError(e, conn, map.get("transCode"), content);
                throw e;
            }
    ...
    public static String doGet(String url, Map<String, String> params,
        ...
        try {
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                LoggerUtil.logCommError(e, url,  map.get("transCode"), params);
                throw e;
            }
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                LoggerUtil.logCommError(e, conn, map.get("transCode"), params);
                throw e;
            }
    ...
    public static String buildXml(Map<String, String> params, String charset) throws Exception {
        if (params == null || params.isEmpty()) {
            return null;
        }
