...
public class GeneralNoticeReqServiceImpl extends AbstractDipperHandler<GeneralNoticeReqDto> {
    private static final Logger LOG = LoggerFactory.getLogger(GeneralNoticeReqServiceImpl.class);
