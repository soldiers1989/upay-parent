 ...
 */
public class NotifyStatusCheckService extends AbstractDipperHandler<NotifyStatusCheckDto> {
    private static final Logger LOG = LoggerFactory.getLogger(NotifyStatusCheckService.class);
