 ...
 */
public class RecordEsbCorePayFlowListService extends AbstractDipperHandler<RecordPayFlowListDto> {
    ...
    public RecordPayFlowListDto execute(RecordPayFlowListDto dto, Message message) throws Exception {
        ...
        Map<String, Object> bodymap= (Map<String, Object>) message.getTarget().getBodys();
...
//        }
        ...
        if(bodymap.get("isEsbCore").equals("N")){
             paySeq = dto.getTransSubSeq();
        }else{
             paySeq = seqService.generateEsbNo();
        }
