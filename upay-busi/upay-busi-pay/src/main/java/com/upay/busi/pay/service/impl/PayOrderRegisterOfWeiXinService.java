...
import com.upay.busi.pay.service.dto.PayOrderRegisterOfWeiXinDto;
...
public class PayOrderRegisterOfWeiXinService extends AbstractDipperHandler<PayOrderRegisterOfWeiXinDto> {
    ...
    @Override
    public PayOrderRegisterOfWeiXinDto execute(PayOrderRegisterOfWeiXinDto payOrderRegisterDto, Message arg1)
            throws Exception {
        ...
        if (StringUtils.isNotBlank(payOrderRegisterDto.getMerNo())) {
            ...
            payOrderListPo.setExtensionParty(mer.getExtensionParty());
