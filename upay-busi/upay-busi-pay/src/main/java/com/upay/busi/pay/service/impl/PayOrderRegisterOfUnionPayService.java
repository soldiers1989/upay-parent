...
import com.upay.busi.pay.service.dto.PayOrderRegisterOfUnionPayDto;
...
public class PayOrderRegisterOfUnionPayService extends AbstractDipperHandler<PayOrderRegisterOfUnionPayDto> {
    ...
    @Override
    public PayOrderRegisterOfUnionPayDto execute(PayOrderRegisterOfUnionPayDto payOrderRegisterDto, Message arg1)
            throws Exception {
